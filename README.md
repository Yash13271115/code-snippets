...
2. terminal_snippet.ps1.ps1 "Create config"
3. notepad $PROFILE
4. "C:\Users\ADMIN\AppData\Roaming\Code\User\snippets\terminal_snippet.ps1.ps1" -> "Add the line on top"
5. $PROFILE -> "Save terminal command save"